...
const Rasayanam = () => {
        ...
        'Maximum 5 minutes would be given to the participant and the car must be autonomous and should not be remote controlled.'],
           specs:
            ['- Announce before two days of event'],
             team:
              ['Maximum participation: 3','Price: ₹150'] }
    },
    { name: 'Synopsis', background: icon2, details: { 
      info: ['It is a paper presentation event in which you have to select a topic based on Chemical Engineering or Pharmacy field.'], 
      rules: [''], 
  ...
  const iconsRow2 = [
    { name: 'Chemaze', background: icon3, details: { 
    ...
    { name: 'ChemX',
     ...
     details: {
       ...
       rules: [''],
        specs: ['- Announce few days befor event'], team: ['Maximum participants: 3','Price: ₹150'] } },
    ...
    <video autoPlay loop muted className="w-full h-full object-cover" width="100%">
      ...
      <Heading
       ...
       <div className="statement">
        <h4>Were you the nerdy Dexter in your childhood, obsessed with the thought of chemicals and test tubes? Do your eyes light up every time you see a solution change its colour? If yes, then Rasayanam welcomes you to the world of the periodic tables and gives you the opportunity to solve their mind-boggling riddles and puzzles and various tasks which will leave you stumped in the mystery of chemistry!</h4>
       </div>
      </div>

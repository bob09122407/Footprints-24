  ...
  const iconsRow1 = [
    {
      ...
      details:
       { info:
         ...
         rules:['The dimensions of vehicle should be 70 x 50 x 50 cm'
...
'The participants are advised to use proper air filters as dirt might cause problems to the IC engine.'],
    ...
    { name: 'Ballista', background: icon2, details: { 
      info: ['It is an event in which participants will have to design an X-bow using elastic, torsional or any other mechanism capable of hitting a given target with variable height and distance.'], 
      rules: ['The top view of the model should be 70 x 70 cm with no restrictions on the height.',
...
'A trigger mechanism is compulsory.'], 
      ...
      details: {
        ...
        rules: ['Make a presentation on any technical topic related to Mechanical Engineering field.',
      ...
      'Only those teams whose abstract is short listed are subjected to pay the event fees. The abstract has to be mailed on lustre@msufp.in by 13th feb’18.'
         ...
         details: {
           ...
           rules: [''],
            ...
            { name: 'Hydrex', background: icon3, details: { 
              info: ['The participants have to build a machine propelled by hydraulics which can climb a given vertical rod and build a hydraulic arm with a hook attached to the machine to lift the given load.'],
              rules:['The dimensions of the base plate should be 60 x 30 with no restriction on height.',
    ...
    <video autoPlay loop muted className="w-full h-full object-cover" width="100%">
      ...
      <Heading
       ...
       <div className="statement">
        <h4>Eloquent ideas are forged, hammered and welded to form powerful machinery that brings about the grandeur of Macheanema. This unleashes the opportunity for Mechanical and Metallurgy engineers to test their knowledge in the arena of practicality. Gather your tools, advance towards the mysterious challenges and rise above the cliché.</h4>
       </div>
      </div>
